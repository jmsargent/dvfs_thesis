...
class BrokerWorkDistributorT
{
   public:
    ...
    __device__ static __forceinline__ void backoff() { nvshmem_fence(); }
    ...
    __device__ int size(int pe) const { return nvshmem_int_atomic_fetch(count, pe); }
};
